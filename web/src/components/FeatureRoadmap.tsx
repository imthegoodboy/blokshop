    ...
    return (
        <section className="bg-gray-50 p-6 rounded-lg">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground list-disc list-inside">
                <li><strong>IPFS encryption</strong> — encrypted uploads and server-side decryption on authorized download</li>
                <li><strong>Per-buyer key delivery</strong> — planned (server-side key management + delivery after purchase)</li>
